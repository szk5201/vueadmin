<template>
    <vxe-grid border show-overflow keep-source ref="xGrid" height="460" :loading="loading" :data="tableData" :columns="tableColumn"
        :toolbar="tableToolbar" :edit-config="{trigger: 'click', mode: 'row'}" @checkbox-change="checkboxChangeEvent"
    ...
    export default {
                ...
                tableColumn: [{
                    ...
                    },
                    {
                        ...
                        editRender: {
                            name: 'ElAutocomplete',
                            props: {
                                fetchSuggestions: this.roleFetchSuggestions
                            }
                        }
                    },
                    {
        ...
        methods: {
            ...
            nsertEvent() {
                ...
                xGrid.insert(record).then(({
                    row
                }) => xGrid.setActiveRow(row))
            },
            saveEvent() {
                let {
                    insertRecords,
