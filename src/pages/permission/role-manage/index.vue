<template lang="html">
  ...
  <el-tab-pane :key="key" :label="role.permissionName">
    ...
    <el-dialog title="新增角色" :visible.sync="dialogFormVisible">
        <el-form :model="form">
            <el-form-item label="角色英文名称" label-width="120px">
                <el-input v-model="form.roleEnName"  maxlength="30" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="角色中文名称" label-width="120px">
                <el-input v-model="form.roleCnName" maxlength="30" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="角色描述" label-width="120px">
                <el-input  v-model="form.roleDescription" maxlength="100"  type="textarea" autocomplete="off"></el-input>
            </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
...
<script>
import { getRoleList, getAllPermissiion, insertRole } from '@/api/permission'
export default {
    data() {
        return {
            form: {
